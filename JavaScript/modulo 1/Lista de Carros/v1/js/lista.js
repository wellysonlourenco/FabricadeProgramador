class GerencimentoCarros {
    ...
    LerDados() {
        ...
        // let chaveMarca = document.getElementById("inputMarca").value
        // let valorModelo = document.getElementById("inputModelo").value

        // let objMarca = JSON.stringify(valorModelo)


        // localStorage.setItem(chaveMarca,objMarca)
        ...
        if (this.localStorage(carros)) {
            if (this.validar(carros)) {
                // for(let i = 0; i< this.lista.length; i++){
                    ...
                    localStorage.setItem(this.marca, JSON.stringify(this.modelo)  )
